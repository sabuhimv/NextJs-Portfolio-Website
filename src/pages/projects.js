    ...
    return (
        ...
        lg:flex-col lg:p-8 xs:rounded-2xl xs-rounded-br-3xl xs:p-4'>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
                <span className='text-primary font-medium text-2xl dark:text-primaryDark xs:text-base'>{type}</span>
                ...
                <div className='mt-2 flex items-center justify-between'>
                    ...
                    bg-dark p-2 px-6 text-light font-semibold dark:bg-light dark:text-dark
        ...
        <>
            ...
            <main className="w-full mb-16 flex flex-col items-center justify-center dark:text-light">
                <Layout className='pt-16'>
                    <Head1 text={"See What I've Built"} className='mb-16' />
                    ...
                    <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                        <div className='col-span-12'>
                            <FeaturedProject
                                ...
                                link={"https://github.com/sabuhimv/IT-Solutions"}
                                github={"https://github.com/sabuhimv/IT-Solutions"}
